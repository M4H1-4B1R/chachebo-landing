...
export function CTASection() {
    return (
        <section className="py-24 relative overflow-hidden bg-[#EFEBE1]">
            <div className="container relative z-10">
                <div className="bg-white rounded-3xl p-12 md:p-24 text-center space-y-8 shadow-xl border border-black/5">
