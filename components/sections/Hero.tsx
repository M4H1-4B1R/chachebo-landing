            ...
            <div className="container grid lg:grid-cols-2 gap-12 items-center relative z-10">
                <div className="space-y-8">
                    <h1 className="text-5xl md:text-6xl font-bold leading-tight text-white">
                        Verify Chinese Vehicle History with <span className="text-primary">Absolute Confidence</span>
                    </h1>
                    <p className="text-xl text-gray-400 max-w-lg">
                        Mitigate import risks with comprehensive Chinese vehicle records, ensuring transparency for traders and buyers worldwide.
                    </p>
                    ...
                    <div className="bg-white/5 p-2 rounded-lg backdrop-blur-sm border border-white/10 flex flex-col sm:flex-row gap-2 max-w-xl">
                        ...
                        <Button size="lg" className="h-12 px-8 rounded-md text-base font-bold shadow-[0_0_20px_rgba(255,122,0,0.3)] hover:shadow-[0_0_30px_rgba(255,122,0,0.5)] transition-shadow">
                            Check History
                        </Button>
                    </div>

                    <div className="flex items-center gap-6 text-sm text-gray-400 font-medium">
                        <span className="flex items-center gap-2 text-primary"><CheckCircle2 className="h-4 w-4" /> Free Sample Report</span>
                        <span className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-green-500" /> 24/7 Support</span>
                        <span className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-green-500" /> Official Sources</span>
                    </div>
                </div>
                    ...
                    <Card className="w-[400px] bg-[#111111] border-white/10 relative overflow-hidden shadow-2xl">
                        ...
                        <CardContent className="p-8 space-y-6">
                            <div className="flex justify-between items-start">
                                <div>
                                    <h3 className="text-white font-bold text-lg">Vehicle Score</h3>
